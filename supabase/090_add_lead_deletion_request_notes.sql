-- Let Sales Project Officers include a required reason when requesting a Lead
-- deletion. This is additive and keeps the existing three-argument RPC working
-- for any already-deployed application version.
