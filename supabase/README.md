...
104. Run `118_sales_pricing_officer_price_review_guard.sql` after `117_mockup_quotation_workflow.sql`, then deploy the matching app update. It lets the assigned Sales & Pricing Officer save calculated direct Price Quotation selling prices during pending review and submit them to the General Manager, while Sales Executives remain blocked from setting Selling Price / Unit.
