...
99. Run `104_price_quotation_endorsements.sql` to let a Sales Executive create an immutable, private PDF copy of their approved Price Quotation for another Sales Executive. Run it before deploying the matching app code.
