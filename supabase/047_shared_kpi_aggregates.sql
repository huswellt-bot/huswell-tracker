-- Shared organization KPI totals for the General Manager and Sales Project Officers.
-- Run after 046_quarterly_sales_targets.sql. This exposes aggregates only, never source rows.
