-- Allow the assigned Sales & Pricing Officer to complete direct Price
-- Quotation pricing and send it to the General Manager.
--
-- Run after 117_mockup_quotation_workflow.sql. Safe to re-run.
