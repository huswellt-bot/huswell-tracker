-- Adds the organization-wide Open Costings metric to the protected shared KPI aggregate.
-- Run after 047_shared_kpi_aggregates.sql. This exposes aggregates only, never source rows.
