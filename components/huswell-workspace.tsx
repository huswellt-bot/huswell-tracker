  ...
  return (
    <section className="rounded-xl border border-[#e1e6ee] bg-[#fafbfc] p-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap items-end gap-2"><label className="text-[12px] font-medium text-[#344054]">VAT<input aria-label="VAT percentage" type="number" min="0" step="any" value={vatRate} onChange={(event) => setVatRate(event.target.value)} className="input ml-2 mt-0 inline-block w-20 px-2 py-1 text-right" />%</label><Button secondary disabled={!canAddCosting} onClick={() => {
        ...
        }}><Plus size={14} /> Add costing table</Button></div>
      </div>
